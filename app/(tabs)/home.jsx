      ...
      <SafeAreaView className="h-full bg-primary">
         ...
         >
          <View className="w-full mt-[5vh] flex-row items-center justify-between">
            <Text className="font-mbold text-white text-3xl">Hello, {userName}</Text>
            <TouchableOpacity
          ...
          <View className="flex-row gap-x-[50px] w-full h-[12vh] items-center justify-center mt-[2vh]">
            <View className="bg-fuchsia-200/50 h-[10vh] w-[15vh] rounded-md items-center p-2">
              <Text className="font-msemibold text-white text-lg">Total</Text>
              <Text className="font-mbold text-white text-3xl">5</Text>
            </View>
            <View className="bg-fuchsia-200/50 h-[10vh] w-[15vh] rounded-md items-center p-2">
              <Text className="font-msemibold text-white text-lg">Online</Text>
              <Text className="font-mbold text-white text-3xl">2</Text>
            </View>
          </View>
          <View className="w-full flex-row items-center justify-start mt-[5vh] gap-x-4">
            ...
            tintColor="#ffffff"
            />
            <Text className="font-mbold text-white text-3xl">Yashas Linux</Text>
          </View>
         </LinearGradient>
